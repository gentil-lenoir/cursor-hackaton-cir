...
<html class="light" lang="en">
    <head>
        ...
        <title>Register | Smart Public Issue Reporting</title>
    ...
    >
        <div class="auth-form-card">
            ...
            <form style="display: flex; flex-direction: column; gap: 1.25rem;" data-auth-form="register" novalidate>
                <div>
                    <label class="dashcode-label" for="name">Full Name</label>
                    <input autocomplete="name" class="dashcode-input" id="name" name="name" placeholder="Aarav Sharma" type="text" />
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    <div>
                        ...
                        <input autocomplete="email" class="dashcode-input" id="email" name="email" placeholder="aarav@example.com" type="email" />
                        <p class="auth-field-error" data-field-error="email"></p>
                    </div>

                    <div>
                        <label class="dashcode-label" for="phone">Phone Number</label>
                        <input
                            autocomplete="tel"
                            ...
                            type="tel"
                        />
                        <p class="auth-field-error" data-field-error="phone"></p>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    ...
                    <div>
                        <label class="dashcode-label" for="password_confirmation">Confirm Password</label>
                        <div style="position: relative;">
                            <input
                                autocomplete="new-password"
                                class="dashcode-input"
                        ...
                        <p class="auth-field-error" data-field-error="password_confirmation"></p>
                    </div>
                </div>
                ...
                <button
                    ...
                    data-idle-label="Create Account"

/** Heroicons-style SVG paths (same shapes as react-icons/hi). */
const ICON_PATHS = {
    ...
    chartBar: 'M3 13h2v8H3v-8zm4-8h2v16H7V5zm4 4h2v12h-2V9zm4-2h2v14h-2V7zm4-2h2v16h-2V5z',
    clipboardList: 'M19 3h-4.18C14.4 1.84 13.3 1 12 1c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm2 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z',
    ...
    exclamation: 'M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z',
    chartPie: 'M11 11V3.055A9.001 9.001 0 0020.945 13H11V11zm2 0h8.945A9.001 9.001 0 0013 3.055V11zm-2 2v8.945A9.001 9.001 0 013.055 11H11v2z',
};

function renderIcon(name) {
    const path = ICON_PATHS[name];
    if (!path) return '';
    return `<svg class="icon" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="${path}"/></svg>`;
}
